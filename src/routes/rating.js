...
router.post('/wardroberating', async (req, res) => {
    ...
    try {
        const prompt = `You are a friendly fashion expert who reviews outfits in a simple, engaging way. Even if given minimal information (such as just "jeans" or "top"), create a complete outfit concept around that items and provide a full review.
                        Respond STRICTLY in this format:
                        **Title**: [5 words maximum that capture the style essence]
                        **Rating**: [Number from 1-5]
                        **Review**: [3-5 sentences that:
